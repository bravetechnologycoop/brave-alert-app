...
import { faBell, faExclamationCircle, faClipboardList, faHandPointer } from '@fortawesome/pro-light-svg-icons'
import { faSensorOn, faHourglassEnd, faRunning } from '@fortawesome/pro-light-svg-icons'
...
function HomeScreenInstructions(props) {
  ...
  function Bold(props) {
    return (
      <Text style={styles.infoBoxBodyTextBold}>
        {props.children}
      </Text>
    )
  }
      ...
      <View style={styles.infoBoxContainer}>
        ...
        { renderButtonsInstructions &&
          <>
            ...
            <InfoBox faIcon={faBell} color={colors.alertActive} drawIconCircle={true}>
        ...
        { renderSensorsInstructions &&
          <>
            ...
            <InfoBox faIcon={faRunning} color={colors.primaryLight} drawIconCircle={true} drawIconSlash={true}>
