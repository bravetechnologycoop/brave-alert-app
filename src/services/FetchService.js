...
async function handleServerError(request, response) {
  ...
  throw new FetchServiceError(text.toString())
}
...
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.BAD_REQUEST_400] = handleServerError
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.UNAUTHORIZED_401] = handleServerError
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.FORBIDDEN_403] = handleServerError
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.NOT_FOUND_404] = handleServerError
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.METHOD_NOT_ALLOWED_405] = handleServerError
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.NOT_ACCEPTABLE_406] = handleServerError
DEFAULT_RESPONSE_HANDLERS[HTTP_STATUS.UNSUPPORTED_MEDIA_TYPE_415] = handleServerError
